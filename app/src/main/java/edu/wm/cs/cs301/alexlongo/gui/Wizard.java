...
import edu.wm.cs.cs301.alexlongo.gui.Robot.Turn;
...
public class Wizard implements RobotDriver, Runnable
{
	...
	private StatePlaying connection;

	private boolean flipper;

	private boolean done;

	public void setConnection(StatePlaying statePlaying)
	{
		connection = statePlaying;
	}
	...
	public void run()
	{
		...
		if(!brokeDown)
		{
			connection.switchFromPlayingToWinning(0, false, robot);
		}
		else
		{
			connection.switchFromPlayingToLosing();
		}
	}
}	// end class Wizard