...
public class WinningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ratRobotEnergyConsumption = findViewById(R.id.textView21);
        ...
        lengthOfPathTaken = findViewById(R.id.textView19);
        lengthOfPathTaken.setText("Length of Path Taken: " + pathLength);

        shortestPossiblePathLength = findViewById(R.id.textView20);
        shortestPath--;
    ...
    public void onBackPressed(){
        Intent mainMenuState = new Intent(WinningActivity.this, AMazeActivity.class);

        // Log the switch
        Log.v( "Bundle", "Switching from WinningActivity to AMazeActivity");
