...
import edu.wm.cs.cs301.alexlongo.generation.BSPBranch;
import edu.wm.cs.cs301.alexlongo.generation.BSPLeaf;
import edu.wm.cs.cs301.alexlongo.generation.BSPNode;
import edu.wm.cs.cs301.alexlongo.generation.Floorplan;
import edu.wm.cs.cs301.alexlongo.generation.Maze;
import edu.wm.cs.cs301.alexlongo.generation.Wall;
import edu.wm.cs.cs301.alexlongo.gui.ColorTheme.MazeColors;
...
public class FirstPersonView {
	...
	private void drawBackground(MazePanel mazePanel, float percentToExit) {
		mazePanel.setColor(ColorTheme.getColor(MazeColors.BACKGROUND_TOP,percentToExit));
		mazePanel.addFilledRectangle(0, 0, viewWidth, viewHeight/2);
		mazePanel.setColor(ColorTheme.getColor(MazeColors.BACKGROUND_BOTTOM,percentToExit));
