...
import edu.wm.cs.cs301.alexlongo.generation.Floorplan;
...
public class StatePlaying {
    ...
    /**
     * The activity is what provides the user input
     */
    private GameplayActivity theActivity;
     ...
     */
    public void start(GameplayActivity currentActivity, MazePanel panel) {
        ...
        this.panel = panel;
        this.theActivity = currentActivity;
        //
	...
	protected void startDrawer() {
		...
		mapView = new Map(seenCells, 45, maze) ;
    ...
    public void switchFromPlayingToWinning(int pathLength, boolean robotUsed, Robot robot) {
        ...
        theActivity.switchToWinningActivity();
    ...
    public boolean handleUserInput(String task)
    {
        switch(task)
        {
            ...
            if (wayIsClear(1))
                theActivity.incrementPathLength(1);
            walk(1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////// OLD HANDLE USER INPUT METHOD SAVED FOR REFERENCE /////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void updateSensors(boolean flipper)
    {
        theActivity.adjustSensors(flipper);
    }
    ...
    {
        theActivity.switchToLosingActivity();
        LOGGER.fine("Control switches from playing to winning screen, game completed.");
    }
}
