...
public class ColorTheme {
    ...
    static Color myColorSetter = new Color();

	// fixed configuration for circle surrounding arms
    private static final int CIRCLE_HIGHLIGHT = Color.parseColor("#010101cc");
    //Color.decode("#115740").darker();// = new Color(1.0f, 1.0f, 1.0f, 0.8f); 
    private static final int CIRCLE_SHADE = Color.parseColor("#0101014d");
